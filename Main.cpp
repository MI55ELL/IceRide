...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "iceSim", NULL, NULL);
	...
	Texture textures[]
	{
		...
		Texture("Textures/grassSpec.png", "specular", 1, GL_RED, GL_UNSIGNED_BYTE)
	};
	...
	{
		"Textures/rightWall.jpg", // positive x
		"Textures/leftWall.jpg", // negitive x
		"Textures/top.jpg", // positive y
		"Textures/snowGround.jpg", // negitive y
		"Textures/behindWall.jpg", // positive z
		"Textures/backWall.jpg" // negitive z
	};
